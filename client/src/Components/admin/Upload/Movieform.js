...
(this.state.image==''||this.state.video=='')){
 ...
 if(!check.data.find)  
       ...
       likes: 0,
        ...
        this.setState({
            error: 'you have previously registered movie with this name'
        }) 
    }
                }  
else 
    ...
    render() {
        return (
         ...
         onChange={this.change}>
             ...
             <span>genre</span> 
             <input type="text" className="form-control my-2" id="genre" onChange={this.change}/>            
             <span>Actors</span> 
             <input type="text" className="form-control my-2" id="actor" onChange={this.change}/>            
             <span>Director</span> 
             <input type="text"  className="form-control my-2" id="director" onChange={this.change}/>            
             <span>image</span> 
